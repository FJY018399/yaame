        ...
        <div v-show="hasLoadedImgs && !rankVisible" class="container" :class="{ bingo: bingoActive }">
            ...
            <div class="content">
                ...
                <div class="turntable">
                    <div class="turntable-box">
                        ...
                        <div class="prize prize2" :class="['active_' + turnTableStatusObj.prize2.status, cursorIndex === 2 ? 'cursor' : '']" @click="selectPrize(2)">
                            ...
                            <!-- <img :src="imgs.prize2" /> -->
                            <div v-show="cursorIndex !== 2 && maskVisible" class="gray-box"></div>
                            <div class="times">5{{ $t("times") }}</div>
                            <img v-show="cursorIndex === 2 && !hasBetting && !timerActive" class="hand" :src="imgs.hand" />
                            <div class="img-container">
                                <img class="reward-img" :src="imgs.prize2" />
                            </div>
                        </div>
                        <!-- 奖品3 猕猴桃 -->
                        <div class="prize prize3" :class="['active_' + turnTableStatusObj.prize3.status, cursorIndex === 3 ? 'cursor' : '']" @click="selectPrize(3)">
                            ...
                            <!-- <img :src="imgs.prize3" /> -->
                            <div v-show="cursorIndex !== 3 && maskVisible" class="gray-box"></div>
                            <div class="times">5{{ $t("times") }}</div>
                            <img v-show="cursorIndex === 3 && !hasBetting && !timerActive" class="hand" :src="imgs.hand" />
                            <div class="img-container">
                                <img class="reward-img" :src="imgs.prize3" />
                            </div>
                        </div>
                        <!-- 奖品4 草莓 -->
                        <div class="prize prize4" :class="['active_' + turnTableStatusObj.prize4.status, cursorIndex === 4 ? 'cursor' : '']" @click="selectPrize(4)">
                            ...
                            <!-- <img :src="imgs.prize4" /> -->
                            <div v-show="cursorIndex !== 4 && maskVisible" class="gray-box"></div>
                            <div class="times">5{{ $t("times") }}</div>
                            <img v-show="cursorIndex === 4 && !hasBetting && !timerActive" class="hand" :src="imgs.hand" />
                            <div class="img-container">
                                <img class="reward-img" :src="imgs.prize4" />
                            </div>
                        </div>
                        <!-- 计时器 -->
                        <div class="timer">
                ...
                <div class="auto-btn" @click="checkAuto">
                    ...
                    <img v-if="autoToggle" src="https://yaame-static.yaame.io/admin/581747dff1d25b48b37545436a0ec59f.png" alt="">
                    <img v-else src="https://yaame-static.yaame.io/admin/a2be5c91b16a04d9655a4abe3a7381d9.png" alt="">
                    <span>AUTO</span>
                </div>
                <!-- btns -->
                <div class="btns">
                ...
                <div class="footer-container">
                    ...
                    <div class="footer">
                        ...
                        <div v-for="(item, index) in match_records" class="footer-img-div">
                            <img class="footer-item" :src="imgs['prize_icon_' + transFruitIndex(item.win_num)]" />
                            <img v-if="index === 0" class="tag-img" src="https://yaame-static.yaame.io/admin/c38ccf5fa17326cfc25c90e0e53f03e4.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
            <!-- 中奖弹窗 -->
            <div v-show="resultVisible" class="mask">
                <div class="mask-card">
                    <div class="mask-title" :style="{ opacity: lastedRecord.reward ? 0 : 1 }">{{ $t("win-title") }}</div>
                    <img class="mask-close" :src="imgs.close" @click="closeResult" />
                    <div v-if="lastedRecord.reward" class="cheer">
                        <!-- 国际化头图 -->
                        <img v-if="locale === 'en'" :src="imgs['cheer-en']" />
                        <img v-if="locale === 'id'" :src="imgs['cheer-id']" />
                        <img v-if="locale === 'zh'" :src="imgs['cheer-zh']" />
                        <img v-if="locale === 'tw'" :src="imgs['cheer-tw']" />
                        <img v-if="locale === 'ar'" :src="imgs['cheer-ar']" />
                    ...
                    <div class="mask-content result-content">
                        ...
                        <div class="result-fruit">
                            ...
                            <img v-show="realWinnerIndex === 1" class="result-fruit-img" :src="imgs['prize' + 1]" />
                            <img v-show="realWinnerIndex === 2" class="result-fruit-img" :src="imgs['prize' + 2]" />
                            <img v-show="realWinnerIndex === 3" class="result-fruit-img" :src="imgs['prize' + 3]" />
                            <img v-show="realWinnerIndex === 4" class="result-fruit-img" :src="imgs['prize' + 4]" />
                            <img v-show="realWinnerIndex === 5" class="result-fruit-img" :src="imgs['prize' + 5]" />
                            <img v-show="realWinnerIndex === 6" class="result-fruit-img" :src="imgs['prize' + 6]" />
                            <img v-show="realWinnerIndex === 7" class="result-fruit-img" :src="imgs['prize' + 7]" />
                            <img v-show="realWinnerIndex === 8" class="result-fruit-img" :src="imgs['prize' + 8]" />
                        </div>
                            ...
                            <div class="record-item" v-for="item in betting_records">
                                ...
                                <div class="record-card">
                                    <div class="record-winner">
                                        <span class="record-label">{{ $t("win-title") }}</span>
...
import { getGameInfoAPI, joinGameAPI, bettingAPI, getRecordsAPI, getWinnerRecordsAPI, getWinnerRecordAPI, getRobotsAPI, getRankAPI, getCurrentTimeAPI } from "./api";
...
export default {
    ...
    mounted() {
        ...
        window.handleH5Event = (msgContent) => {
            this.onChatroomMsgs(JSON.parse(JSON.stringify(msgContent)));
        };
    ...
    methods: {
        ...
        async getRank() {
            ...
            try {
                const res = await request.getActivityRank({
                    ...
                    activityRankType: "GREEDY_FOOTBALL_GAME",
                });
                if (res.status === 1000) {
         ...
         */
         startTurn() {
            ...
            let reduceTimes = [6720, 6760, 6800, 6840, 6880, 6920, 6960, 7000];
            let n = 0;
            ...
            setTimeout(() => {
                if (this.getEndInfoSuccess) return;
                this.getEndInfo();
            }, 2000);

            let getResult = false;
            setTimeout(() => {
                if (this.realWinnerIndex !== -1) {
                    getResult = true;
                }
            }, 6500);
            this.time = 10;
            ...
            this.turnTableInterval = setInterval(() => {
                ...
                } else if (this.realWinnerIndex === -1 || !getResult) {
        ...
        getEndInfo () {
            getWinnerRecordAPI({
                ...
                if (res.status === 1000) {
                    ...
                    if (res.data.max_reward_users) {
                        data.r = res.data.max_reward_users;
                    }
                    this.gameOver(data);
                    this.gameStatus = 1;
                    this.getEndInfoSuccess = true;
                }
            })
        },
        /**
        ...
        async gameOver(data) {
            ...
            if (r && r.length >= 3) {
                ...
                let res = await getRobotsAPI({ num, type });
                if (res.status === 1000) {
                    let robot_list = res.data.robot_list || [];
                    robot_list &&
                        robot_list.forEach((item) => {
        ...
        bettingAnimation(diamondIndex, prizeIndex) {
            ...
            let startLeft = [1, 2.6, 4.4, 6];
            let startTop = 8.4;
            let endLeft = [2.7, 4.4, 5.6, 5.6, 4.4, 2.7, 1.5, 1.5];
            let endTop = [3.4, 3.4, 4.6, 6.3, 7.5, 7.5, 6.3, 4.6];
            // 钻石到初始位置
            let animationObj = {
        ...
        showRank() {
            ...
            location.href = "./diamondRank.html?activityRankType=GREEDY_FOOTBALL_GAME";
        },
        // 展示记录弹窗
        showRecord() {
            try {
        ...
        onChatroomMsgs(msg) {
            ...
            // let msg;
            // if (text.msg_type === "H5_EVENT") {
            //     msg = text.msg_data.event_data;
            // } else {
            //     msg = text;
            //     msg.data = msg.msg_data;
            //     msg.event_type = msg.msg_type;
            // }
            ...
            let msg_type = msg.event_type;
            console.log("收到聊天室消息===> 客户端", msg_type, msg_data);
            switch (msg_type) {
                case "GREEDY_FOOTBALL_MATCH_CREAT":
                    window.DATAFLUX_RUM &&
                        window.DATAFLUX_RUM.addAction("投注阶段开始", {
                            yaame_open_uid: this.open_uid,
                            yaame_device_id: this.device_id,
                            yaame_custom_data: msg,
                        });
                    // 投注阶段开始
                    this.initGame();
                    // 修改游戏状态
                    this.gameStatus = 0;
                    break;
                case "GREEDY_FOOTBALL_MATCH_OVER":
                    window.DATAFLUX_RUM &&
