...
<script setup>
    ...
    const logoImg = ref({
        ...
        "en": "https://yaame-static.yaame.io/admin/c58f0ec653ef954fb239adc55320b746.png",
        "id": "https://yaame-static.yaame.io/admin/cec4fb0c32598b9c1d17bcf98e5a11e7.png",
        "zh-cn": "https://yaame-static.yaame.io/admin/05e90c670325c708822fb2bcfb3a4a90.png",
...
.main {
    ...
    background: url("https://yaame-static.yaame.io/admin/1fde20b11d3c97fdd73d7a09ecf450ba.png") no-repeat;
    ...
    .time {
        ...
        .times {
            ...
            align-items: center;
            background: url("https://yaame-static.yaame.io/admin/53cd16adc34a706718fac4821e5f2a72.png") no-repeat;
            background-size: contain;
        }
    ...
    .tab {
        ...
        .tabs {
            ...
            padding-top: .28rem;
            background-image: url("https://yaame-static.yaame.io/admin/a40ba6069324738719005d73e11dc080.png");
            background-size: contain;
            background-repeat: no-repeat;
        ...
        .bgi {
            background-image: url("https://yaame-static.yaame.io/admin/7ef07794907add9324f7792da0659a77.png");
        }
    ...
    .my-list {
        ...
        height: 2.4rem;
        padding-right: .3rem;
        background: url("https://yaame-static.yaame.io/admin/f083268ca33dcbef2b843ee01d7bc0be.png") no-repeat;
        background-size: contain;
        font-size: .24rem;
        color: #FFFFFF;
        z-index: 4;
    ...
    .rule {
        ...
        font-size: .28rem;
        color: #FFFFFF;
        background: url("https://yaame-static.yaame.io/admin/ffffbf6d8a73cf0576d9bb9e79ea2aff.png") no-repeat;
        background-size: 100%;
        z-index: 3;
    }
    ...
    .popup {
        ...
        .rule-page {
            ...
            background: linear-gradient(180deg, #5D05DE 0%, #2F02B9 100%);
