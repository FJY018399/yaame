 ...
 * @LastEditTime: 2024-09-11 10:53:41
 * @Description:
...
export const getGoodsAPI = async (type) => {
    let url = await getBaseUrl("get", "/yaame/api/web/payment/goods/v2");
...
export const orderAPI = async (data) => {
    let url = await getBaseUrl("post", "/yaame/api/web/payment/order/v2");
    if (data.web_uid) {
