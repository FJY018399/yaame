...
.daily {
    ...
    .daily-time {
        ...
        .time {
            ...
            .times {
                ...
                height: .44rem;
                margin: 0 .05rem;
                background: url("https://yaame-static.yaame.io/admin/7c2ee5d6fd4dc4adf368bd8cc1c038df.png") no-repeat;
                background-size: contain;
                font-weight: bold;
            }
        }
    ...
    .gears-award {
        ...
        .award {
            ...
            height: 3.2rem;
            margin-bottom: .2rem;
            background-image: url("https://yaame-static.yaame.io/admin/5dc62903fb60a9b17666959dac5d1696.png");
            background-repeat: no-repeat;
            background-size: contain;
            .award-img {
                position: absolute;
        ...
        .award-reach {
            background-image: url("https://yaame-static.yaame.io/admin/f668db8af0f038ddef4114ba333ac577.png");
        }
        .award-grant {
            background-image: url("https://yaame-static.yaame.io/admin/444c136d60df0c9b1c3a1fa666d28194.png");
        }
    }
}
</style>