export default {
	...
	"reward-desc-1":
		'1. The inviter could receive 💎300 after the invitee finished " Continuously staying in the room over 1 hour for last 3 days, after registration".',
	"reward-desc-2":
		'2. The inviter could receive 💎500 after the invitee finished " Continuously staying in the room over 1 hour for last 7 days, after registration".',
	"reward-desc-3":
		"3. The inviter will receive 10% diamonds rebate of the invitee first recharge as rewards, max diamonds reward could be 10k .",
    ...
    // 每周邀请任务
	"invite-task": "Monthly Invitation Tasks",
	// 按UTC0时区计算，每周任务刷新，可重复完成任务。
	"task-desc": "Calculated by UTC0 time zone, tasks are refreshed  monthly and can be completed repeatedly.",
	// 剩余刷新时间
